...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  void _placeBlock() {
    ...
    final tolerance = _levelData.tolerance;
    final isPerfect = (_movingX - top.x).abs() <= tolerance;
    ...
    setState(() {
      ...
      if (isPerfect) {
        if (_perfectStreak >= 3) {
          _bonusText = '⚡ STREAK x$_perfectStreak  +${bonus + 1}';
        } else {
          _bonusText = '✦ PERFECT  +$bonus';
        }
      }
    });
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'LVL ${widget.level}  •  ${_levelData.name}',
          ...
          AnimatedBuilder(
            ...
            builder: (_, child) => Transform.scale(
              scale: _scorePopAnimation?.value ?? 1.0,
              child: child,
            ),
            child: Column(
              children: [
  ...
  Widget _buildBlock({required double width, required Color color, bool isTop = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          if (isTop)
            BoxShadow(color: color.withValues(alpha: 0.7), blurRadius: 16, spreadRadius: 1),
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(top: BorderSide(color: Colors.white.withValues(alpha: 0.45), width: 1.5)),
        ),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Center(
                child: Icon(Icons.pause_rounded, color: AppColors.primary, size: 32),
              ),
            ),
                  ...
                  child: Row(
                    ...
                    children: const [
                      Icon(Icons.emoji_events_rounded,
                          color: Color(0xFF030814), size: 16),
                      SizedBox(width: 6),
                      Text(
                        'NEW HIGH SCORE!',
                        style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: primary ? null : Border.all(color: AppColors.primary.withValues(alpha: 0.3)),
        ...
        child: Row(
          ...
          children: [
            Icon(icon,
                color: primary ? const Color(0xFF030814) : AppColors.primary, size: 20),
            const SizedBox(width: 10),
            Text(
              label,
              style: TextStyle(
